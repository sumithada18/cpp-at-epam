...
// We can store class objects in a std::set, but we must overload the < operator so that the set can 
// compare and order objects correctly.
// Set uses this comparison to maintain sorted order and ensure uniqueness.
...
//	printSet(set1);
  ...
  // Making set of objects of a class type ====================================================
   std::set<person>people;
    people.insert(person(10, "sumit"));
    people.insert(person(10, "sparsh"));
    people.insert(person(2, "priyanshu"));
